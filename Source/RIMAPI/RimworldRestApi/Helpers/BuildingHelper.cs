...
#elif RIMWORLD_1_6
                DamageAmount = verbProps.defaultProjectile?.projectile?.GetDamageAmount(1f, null) ?? 0,
                ArmorPenetration = verbProps.defaultProjectile?.projectile?.GetArmorPenetration() ?? 0f,
#endif
